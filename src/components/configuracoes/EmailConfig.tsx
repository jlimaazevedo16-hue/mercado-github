...
import { Mail, Send, CheckCircle, XCircle, Loader2, AlertTriangle, Lock, ExternalLink } from "lucide-react";
    ...
    try {
      const result = await sendGenericEmail(
        ...
        "Teste de E-mail - Mercado Municipal Digital",
        {
          ...
          conteudo: `
            <p>Este é um e-mail de teste enviado pelo sistema Mercado Municipal Digital.</p>
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <ul className="text-sm text-muted-foreground mt-2 space-y-1">
                ...
                <li>• <strong>Variáveis dinâmicas:</strong> Personalização automática do conteúdo.</li>
